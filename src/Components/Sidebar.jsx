...
function NavBar() {
  ...
  const navItems = ["Home", "Portfolio", "My Story", "Skills"]; // replace with your own navItems
  const navIcons = ["home", "briefcase-alt-2", "user-pin", "terminal"];
  const navTo = ["hero", "portfolio", "story", "skills"];
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (currentPosition > 0 && currentPosition < 600) {
        ...
        setActiveNavItem(2);
      } else if (currentPosition > 2000 && currentPosition < 3200) {
        setActiveNavItem(3);
      }
    };
...
function Hamburger() {
  ...
  const navItems = ["Home", "Portfolio", "My Story", "Skills"];
  const navTo = ["hero", "portfolio", "story", "skills"];
