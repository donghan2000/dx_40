...
export default function Gallery() {
  ...
  return (
    <>
      <div
        items={items}
        className={`work-modal ${modal ? "animate__animated animate__backInUp" : ""}`}
      ...
      >
        ...
        <div className="work-flex-div">
          <div className="work-modal-div">
            <img
              className="work-modal-images"
              src={items[openedModal].workContentImage}
              alt="gallery-images"
            />
          </div>
          ...
          <div className="works-modal-title">
            ...
            <a
              className="pro-link"
              href={items[openedModal].linkGoto}
              target="_blank"
            >
              {items[openedModal].linkText}
            </a>
            <a
              className="pro-link"
              href={items[openedModal].linkSecondGoto}
              target="_blank"
            >
              {items[openedModal].linkSecondText}
            </a>
          </div>
        </div>
      </div>
      ...
      <section className="section-dividers" id="portfolio">
        <div className="work-flex fill center work-container">
          <div className="title">
            ...
            <h1
              className={`${addClass ? "animate__animated animate__fadeIn" : ""}`}
            >
              My Portfolio
            </h1>
            {/* <p
            ...
            >
              <p>
                My portfolio showcase a collection of my ideas, creativity, and
                work. Each project reflects my passion for learning, building,
                and turning ideas into reality. It includes works I did such as
                website, mobile app, product and illustration works.
              </p>
            </div>
          </div>

          <div
            className={`work-main ${addSecClass ? "animate__animated animate__fadeInRight opacity-class" : ""}`}
          >
            <Slider
              items={items}
              width={700}
                ...
                <div className="work-content">
                  ...
                  <a.div
                    ...
                    style={{
                      ...
                      backgroundSize:
                        i === activeHovered && isHovering ? "150%" : "100%",
                    }}
          ...
          <div
            className={`nav-works-index ${addSecClass ? "animate__animated animate__fadeIn opacity-class" : ""}`}
          >
            {items.map((item, i) => (
              <div
                key={i}
