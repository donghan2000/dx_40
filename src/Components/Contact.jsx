  ...
  const Globe = (props) => {
    ...
    useFrame((state, delta) => {
      ...
      globeRef.current.rotation.y =
        -Math.sin(state.clock.elapsedTime / 20) * 0.2;
    });
      ...
      <section className="section-dividers" id="contact">
        ...
        <div className="contact-div">
          <div className="contact-form">
            <div
              className={`contact-p ${addClass ? "animate__animated animate__fadeIn animate__delay-2s" : ""}`}
            >
            ...
            <div
              className={`contact-sub-text ${addClass ? "animate__animated animate__fadeIn animate__delay-2s" : ""}`}
            >
              <p>
                Thank you for taking the time to visit my website. If you have
                any questions or would like to get in touch with me, please feel
                free to use the contact form below.
              </p>
            </div>

            <div
              className={`form-div ${addClass ? "animate__animated animate__fadeIn animate__delay-2s" : ""}`}
            >
              <form
                action="https://formsubmit.co/37ce8add4d3e5112d718c592e53217b8"
                method="POST"
              >
                {/* Honey Pot */}
                ...
                <input
                  type="hidden"
                  name="_next"
                  value="http://donghan.co/success.html"
                />
                ...
                <button
                  ...
                  method="POST"
                >
                  <a aria-disabled="true" className="button">
                    CONTACT ME
                  </a>
                </button>
              </form>
          ...
          <div
            ref={canvasRef}
            className={`contact-canvas ${addClass ? "animate__animated animate__fadeIn" : ""}`}
          >
            {inView && (
              <Canvas
                className={`${addClass ? "animate__animated animate__fadeIn  animate__delay-1s" : ""}`}
                performance={{ max: 0.1 }}
                camera={{ position: [30, -2, -5] }}
              >
                <directionalLight
                  position={[-80, 200, 40]}
                  intensity={0.8}
            ...
            <div
              className={`address ${addClass ? "animate__animated animate__backInUp animate__delay-4s" : ""}`}
            >
              <div className="add-text">
                <p>Low Dong Han,</p>
                <p>Ang Mo Kio Avenue 10</p>
                <p className="email-click" onClick={handleEmailClick}>
                  {" "}
                  <span className="span-add">@ </span> : donghan20002@gmail.com
                </p>
              </div>
            </div>
          </div>
